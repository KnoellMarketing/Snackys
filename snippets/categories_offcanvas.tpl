...
<ul class="nav navbar-nav">
    <li class="clearfix">
        <a href="#" class="nav-sub pull-left" data-ref="0">{lang key="showAll" section="global"}</a>
        <a href="#" class="nav-sub pull-right" data-ref="{$result->current->kOberKategorie}">{lang key="back" section="global"}</a>
    </li>
