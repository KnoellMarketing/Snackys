        ...
        {if !empty($oCurNewsCat)}
            ...
            <div class="row">
                {if !empty($oCurNewsCat->cPreviewImage)}
                    <div class="col-sm-8 col-xs-12">{if $snackyConfig.optimize_news == "Y"}{$oCurNewsCat->cBeschreibung|optimize}{else}{$oCurNewsCat->cBeschreibung}{/if}</div>
                    <div class="col-sm-4 col-xs-12 pr"><div class="img-ct"><img src="{$snackyConfig.preloadImage}" data-src="{$oCurNewsCat->cPreviewImage}" class="img-responsive center-block"></div></div>
                {else}
                    <div class="col-sm-12">{if $snackyConfig.optimize_news == "Y"}{$oCurNewsCat->cBeschreibung|optimize}{else}{$oCurNewsCat->cBeschreibung}{/if}</div>
                {/if}
            </div>
            <hr>
